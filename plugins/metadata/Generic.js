...
YAHOO.macaw.Generic = function(parent, data) {
	...
	YAHOO.macaw.Generic.metadataFields = [
		{ id: 'generic_name', display_name: 'Name', type: 'text'},
		{ id: 'generic_type', display_name: 'Type', type: 'select-one'},
		{ id: 'generic_text', display_name: 'Text', type: 'text'}
	];
	...
	this.getTableColumns = function() {
		var cols = [];
		var fields = YAHOO.macaw.Generic.metadataFields;
		for (f in fields) {
			cols.push({
				'key':   fields[f].id,
...
//
// ----------------------------
YAHOO.macaw.Generic.metadataChange = function(obj) {
